<form class="ms2_form" id="msOrder" method="post">
    <div class="row">
        <div class="col-12 col-md-6">
            <div>
                <h4>{'eg_cart_bayyerdat' | lexicon}:</h4>
            ...
            <div>
                ...
                {foreach ['city', 'street'] as $field}
                    <div class="form-group row input-parent">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="{$field}" placeholder="{('ms2_frontend_' ~ $field) | lexicon}"
                                   name="{$field}" value="{($field=='city')?$modx->getPlaceholder('region.city'):$form[$field]}"
                                   class="form-control{($field in list $errors) ? ' error' : ''}">
                        </div>
                    </div>
                {/foreach}
    ...
    <div class="row justify-content-center justify-content-md-start">
        ...
        <button type="submit" name="ms2_action" value="order/submit" class="btn btn-lg btn-warning m-2 ms2_link">
