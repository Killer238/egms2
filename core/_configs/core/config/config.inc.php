...
if (!defined('MODX_CORE_PATH')) {
    $modx_core_path= '/home/ms/matras-stock.ru/www/core/';
    define('MODX_CORE_PATH', $modx_core_path);
}
if (!defined('MODX_PROCESSORS_PATH')) {
    $modx_processors_path= '/home/ms/matras-stock.ru/www/core/model/modx/processors/';
    define('MODX_PROCESSORS_PATH', $modx_processors_path);
}
if (!defined('MODX_CONNECTORS_PATH')) {
    $modx_connectors_path= '/home/ms/matras-stock.ru/www/connectors/';
    $modx_connectors_url= '/connectors/';
    define('MODX_CONNECTORS_PATH', $modx_connectors_path);
    define('MODX_CONNECTORS_URL', $modx_connectors_url);
}
if (!defined('MODX_MANAGER_PATH')) {
    $modx_manager_path= '/home/ms/matras-stock.ru/www/manager/';
    $modx_manager_url= '/manager/';
    define('MODX_MANAGER_PATH', $modx_manager_path);
    define('MODX_MANAGER_URL', $modx_manager_url);
}
if (!defined('MODX_BASE_PATH')) {
    $modx_base_path= '/home/ms/matras-stock.ru/www/';
    $modx_base_url= '/';
...
if (!defined('MODX_ASSETS_PATH')) {
    $modx_assets_path= '/home/ms/matras-stock.ru/www/assets/';
